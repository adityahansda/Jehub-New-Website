...
export const appwriteConfig = {
  ...
  collections: {
    ...
    reports: process.env.NEXT_PUBLIC_APPWRITE_REPORTS_COLLECTION_ID || '687f4f6d002703bb13b6',
    ...
    deviceTracking: process.env.NEXT_PUBLIC_APPWRITE_DEVICE_TRACKING_COLLECTION_ID || '6891e3230038cb19a6f0',
    bannedDevices: process.env.NEXT_PUBLIC_APPWRITE_BANNED_DEVICES_COLLECTION_ID || '6891e3e5002a8d732862',
