...
const WishlistRegister = () => {
  ...
  const validateCollegeEmail = (email: string) => {
    const collegeEmailRegex =
      /^[a-zA-Z0-9._%+-]+@[a-zA-Z0-9.-]+\.(edu|ac\.in|edu\.in)$/;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.collegeEmail.trim()) {
      ...
      !/^([a-zA-Z0-9._%+-]+)@((gmail\.com)|(outlook\.com)|([a-zA-Z0-9.-]+\.(edu|ac\.in|edu\.in)))$/.test(
        formData.collegeEmail
      )
    ) {
      newErrors.collegeEmail =
        "Only valid emails are accepted (.edu, .ac.in, .edu.in, gmail.com, outlook.com)";
    }
    ...
    return (
      <>
        <Head>
          ...
          <meta
            name="description"
            content="Successfully registered for JEHUB beta wishlist"
          />
          <meta
            name="viewport"
          ...
          <div className="max-w-md mx-auto">
            <div className="bg-[#1c1c1f] rounded-2xl border border-[#2d2d30] p-8 text-center">
              ...
              <p className="text-[#d1d5db] mb-6">
                Thank you for joining JEHUB&apos;s beta wishlist! You&apos;ll be
                among the first to access our platform when we launch.
              </p>
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Register for JEHUB beta access with your student information"
        />
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#0e0e10] to-[#1c1c1f] py-8 px-4">
        ...
        <div className="max-w-2xl mx-auto mb-8">
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-[#d1d5db]">
              Be among the first students to experience the future of academic
              collaboration
            </p>
          </div>
        </div>
        ...
        <div className="max-w-md mx-auto">
          <form
            ...
            className="bg-[#1c1c1f] rounded-2xl border border-[#2d2d30] p-8 space-y-6"
          >
            {/* Student Name */}
            <div>
              <label
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-[#666]">
                We only accept official college email addresses (.edu, .ac.in,
                .edu.in)
              </p>
            </div>
