            ...
            <div className="h-full flex flex-col">
              ...
              <div className="p-6 border-b border-gray-200 dark:border-gray-700">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white leading-tight">JEHUB</h2>
                    <p className="text-sm text-gray-500 dark:text-gray-400 leading-tight">Student Portal</p>
                  </div>
                </div>
              </div>
