...
export default async function handler(
  ...
  try {
    ...
    console.log(`Fetching documents from Appwrite for Intern ID: ${internId}`);

    const documentResult = await appwriteInternshipService.getDocumentsForDownload(internId);
    ...
    console.error('Appwrite certificate downloader error:', error);
